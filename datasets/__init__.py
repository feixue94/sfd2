...
try:
    ...
    print("Dataset aachen_style_transfer_pairs not available, reason: ", e)

try:
    aachen_flow_pairs = AachenPairs_OpticalFlow()
except AssertionError as e:
    # print(f"Dataset aachen_flow_pairs not available, reason: {e}", file=sys.stderr)
    print("Dataset aachen_flow_pairs not available, reason: ", e)
